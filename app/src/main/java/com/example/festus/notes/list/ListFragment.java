...
public class ListFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        noteCollectionViewModel = ViewModelProviders.of(this, viewModelFactory)
                .get(NoteCollectionViewModel.class);

        noteCollectionViewModel.getListOfNotes().observe(this, new Observer<List<Note>>() {
            @Override
    ...
    private ItemTouchHelper.Callback createHelperCallback() {
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                noteCollectionViewModel.deleteNote(
